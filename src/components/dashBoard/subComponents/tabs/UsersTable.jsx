...
export default function UsersTable(props) {
  ...
  const [updateDialogSelectedUserData, setUpdateDialogSelectedUserData] =
    useState({});
  ...
  return (
    <>
          ...
          {props.users.map((user, idx) => {
            return (
              ...
              >
                ...
                <TableCell align="right" component="th" scope="row">
                  <LoadingButton onClick={() => handleUpdateUser(user)}>
                    Update Info
                  </LoadingButton>
                </TableCell>
                <TableCell align="right" component="th" scope="row">
                  <LoadingButton onClick={() => handleDeleteUser(user)}>
                    Delete
                  </LoadingButton>
                </TableCell>
              </TableRow>
      ...
      <UpdateDialog
        user={updateDialogSelectedUserData}
        check={showUpdateDialog}
        handleClose={handleCloseUpdate}
      />
      <DeleteDialog
        user={deleteDialogSelectedUser}
        check={showDeleteDialog}
